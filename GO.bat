...
node "C:\$\Code\codebasement\Preprocess.js" TM %1&                                                      rem Run Dave's custom pre-processor tool-chain, passing along the path and file name of current Notepad++ tab.
